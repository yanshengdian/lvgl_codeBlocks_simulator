...
void ui_power_up_init(void)
{
    ...
    lv_obj_set_style_pad_all(scr_power_up, 0, LV_PART_MAIN);
    lv_obj_set_scrollbar_mode(scr_power_up, LV_SCROLLBAR_MODE_OFF);
    lv_obj_clear_flag(scr_power_up, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_timer_create(ui_power_up_timeout_cb, 1500, NULL);
}
